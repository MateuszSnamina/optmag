...
ModificationResult modify_eval_partial_prod(ExpressionHandler&& expression) {
    // ***************************************************************
    ...
    const auto accumulated_value = boost::accumulate(value_of_child_expressions, 1.0, std::multiplies<double>());
